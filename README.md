...
4. Update the `terraform_gcp/variables.tf` and `terraform_gcp/backend.tf` with your desired configuration parameters, such as cluster name, region, zone, sa_name, sa_account and bucket for infrastructure.
